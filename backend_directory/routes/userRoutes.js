...
const {registerUser, loginUser, allUsers, bookmarks, removeBookmarks, sendotp, getUserBookmarks, updateUserDetails, getUser, verifyOtp} =require('../backend_directory/controllers/userControllers')
